...
echo New Cambridge by MillaBasset (SashLilac on Github)
echo ===========================================================================
cd C:\Cambridge\cambridge-master
...
echo ===========================================================================
echo cambridge - Download latest Cambridge version from master branch
...
echo dtet      - Download "DTET Ruleset Mod" (Requires OG)
echo ===========================================================================
echo cancel    - Go back to download link manager
echo ===========================================================================

set /p command=do:
if %command% == og goto cambridgedl
if %command% == l2d32 start "" https://github.com/love2d/love/releases/download/11.3/love-11.3-win32.exe
if %command% == l2d64 start "" https://github.com/love2d/love/releases/download/11.3/love-11.3-win64.exe
if %command% == cancel goto open
goto dlmgr
...
echo Big thanks to MillaBasset, Oshisaure, HammrTime and Mizu for putting time and effort to bring a pleasant stacking experience!
